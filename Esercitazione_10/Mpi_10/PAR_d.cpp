...
int main (int argc, char *argv[]){
   ...
   int sender_rank; //E' il nodo che invia la comunicazione: sono io, rank.
   ...
   //cout << "Prima. Sono il nodo " << rank << " dei " << size << " che hai utilizzato." << endl;
   //cout << "Ho selezionato i numeri " << sender_rank << " e " << receiver_rank << endl;  
   cout << "Prima. Sono il nodo " << sender_rank << " e vorrei comunicare con il nodo " << receiver_rank << endl;  
