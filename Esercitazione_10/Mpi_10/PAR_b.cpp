...
int main (int argc, char *argv[]){
   ...
   if(rank==1){
      MPI_Send(&imesg1, 1, MPI_DOUBLE, 0, itag, MPI_COMM_WORLD);
      MPI_Recv(&imesg2, 1, MPI_DOUBLE, 0, itag, MPI_COMM_WORLD, &stat);
      ...
      MPI_Send(&imesg2, 1, MPI_DOUBLE, 1, itag, MPI_COMM_WORLD);
      MPI_Recv(&imesg1, 1, MPI_DOUBLE, 1, itag, MPI_COMM_WORLD, &stat);
