...
int main (int argc, char *argv[]){
   ...
   if(rank==sender_rank){ //Se io sono stato scelto come il nodo che invia.
      ...
      //In imesg1 tengo in memoria quello che ho INVIATO.
      //In imesg2 tento in memoria quello che ho RICEVUTO.
      ...
      //In imesg1 tengo in memoria quello che ho RICEVUTO.
      //In imesg2 tento in memoria quello che ho INVIATO.
  ...
  /*Esempio di output per 4 nodi.
   ...
   Sono il nodo 0 ho estratto 0 e 2
   Sono il nodo 0 e sono sender rank!
   Sono il nodo 1 e non ho nessun compito.
   Sono il nodo 2 e sono receiver rank!
   Sono il nodo 3 e non ho nessun compito.
   Dopo. Sono il nodo 0 e ho INVIATO il numero 0
   Dopo. Sono il nodo 0 e ho RICEVUTO il numero 2
   Dopo. Sono il nodo 2 e ho INVIATO il numero 2
   Dopo. Sono il nodo 2 e ho RICEVUTO il numero 0*/
